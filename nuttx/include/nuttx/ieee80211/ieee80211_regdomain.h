...
extern uint16_t	 ieee80211_name2countrycode(const char *);
extern uint32_t	 ieee80211_name2regdomain(const char *);
extern const char	*ieee80211_countrycode2name(uint16_t);
extern const char	*ieee80211_regdomain2name(uint32_t);
extern uint32_t	 ieee80211_regdomain2flag(uint16_t, uint16_t);
extern uint32_t	 ieee80211_countrycode2regdomain(uint16_t);
